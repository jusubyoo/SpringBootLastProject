            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single_catagory wow fadeInUp" data-wow-delay=".3s">
                        <img src="/img/seoul.jpg" style="330px;height:238px;">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single_catagory wow fadeInUp" data-wow-delay=".6s">
                        <img src="/img/busan.jpg" style="330px;height:238px;">
                        <div class="catagory-title">
                            <a href="#">
                                <h5>부산 여행 코스</h5>
                            </a>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single_catagory wow fadeInUp" data-wow-delay=".9s">
                        <img src="/img/jeju.jpg" style="330px;height:238px;">
                        <div class="catagory-title">
                            <a href="#">
                                <h5>제주 여행 코스</h5>
                            </a>
                        ...
                        <div class="col-12">
                            <div class="single-post wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div class="post-thumb">
                                    <embed src="http://youtube.com/embed/rXxMznufeL0\u0026t=1021s"
                        ...
                        <div class="col-12">
                            <div class="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".2s">
                                ...
                                <div class="post-content">
                                    ...
                                    <p><b>사용시간</b> : ${vo.avo.usetime }</p>
                                    <p><b>휴무일</b> : ${vo.avo.restdate }</p>
                                    <p><b>주차</b> : ${vo.avo.parking }</p>
                                    <a href="#" class="read-more">Continue Reading..</a>
                                </div>
                            </div>
                        </div>
