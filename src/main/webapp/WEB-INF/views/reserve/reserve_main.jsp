		          	...
		          	<table class="table">
		          		...
		          		<tr>
		          			<td colspan="2" class="text-center">
		          				...
		          				<button class="btn-xs btn-success" @click="store.next()">다음</button>
		          			</td>
		          		</tr>
		          	</table>
		          </div>
		          ...
		          <div class="card-body text-center">
		            ...
		            <table class="table table-borderless text-start">
		              <tbody>
		              	<tr>
		              		<td colspan="2" class="text-center">
		              			<img :src="store.image" style="width: 200px;height: 250px;">
		              		</td>
		              	</tr>
		        ...
		        <div class="card">
		          ...
		          <div class="card-body text-center">
		            <div class="d-flex justify-content-center gap-2 flex-wrap" v-show="store.isTime">
		              <span class="btn btn-xs btn-success" v-for="(t,i) in store.time_list" :key="i"
		        ...
		        <div class="card">
		          ...
		          <div class="card-body text-center">
		            <div class="d-flex justify-content-center gap-2 flex-wrap" v-if="store.isInwon">
		              <span class="btn btn-xs btn-warning" v-for="(t,i) in store.inwon_list" :key="i"
		              style="margin-left: 2px;" @click="store.inwonSelect(t)">
		              {{t}}
		              </span>
		            </div>
		          </div>
    			...
    			watch(()=>store.no,(newVal)=>{
    				...
    				const calendar=new FullCalendar.Calendar(
        					document.getElementById('calendar'),{
        						...
        						dateClick(info){
        							alert(info.dateStr)
        							store.dateSelect(info.dateStr) // 날짜 선택
        							store.isTime=true
        							store.timeListData()
        						}
        					}
