...
<!-- ****** Breadcumb Area Start ****** -->
    ...
    <section class="archive-area section_padding_80" id="join_section">
        <div class="container" style="max-width: 270px; margin-top: 40px;">
		        	...
		        	<table class="table">
		        		<tbody>
		        			<tr>
		        				...
		        				<td width="80%">
		        					<input type="text" name="userid" size=20 class="input-sm">
		        				</td>
		        			</tr>
		        			<tr>
		        				<th class="text-center" width=20%>Password</th>
		        				<td width="80%">
		        					<input type="password" name="userpwd" size=20 class="input-sm">
		        				</td>
		        			</tr>
		        			<tr>
