		...
		<tbody>
			...
			<tr>
				<td colspan="4" class="text-right">
					<a href="/admin/notice_update?no=${vo.no }" class="btn btn-sm btn-danger">수정</a>
					<a href="/admin/notice_delete?no=${vo.no }" class="btn btn-sm btn-danger">삭제</a>
					<a href="/admin/notice_list" class="btn btn-sm btn-danger">목록</a>
				</td>
			</tr>
